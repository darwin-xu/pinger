...
By default excludes: .git, venv, .venv, __pycache__, node_modules, .pytest_cache, and version.txt
"""
...
EXCLUDE_DIRS = {".git", "venv", ".venv", "__pycache__", "node_modules", ".pytest_cache", ".github"}
EXCLUDE_FILES = {"version.txt", ".gitignore", "pinger.db*", "*.md", "config.yaml*", "*.txt"}
...
def main(argv: List[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Compute repository checksum and list hashed files.")
    parser.add_argument("--root", "-r", default=None, help="Repository root (defaults to script directory)")
    parser.add_argument("--no-list", action="store_true", help="Do not print the file list, only checksum")
